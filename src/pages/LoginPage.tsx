...
import { Alert, Backdrop, CircularProgress, Container, Grow, IconButton, InputAdornment, Stack, TextField, Typography } from "@mui/material";
...
const LoginPage = () => {
    ...
    useEffect(() => {
        setEmpresa(empresa);
        if (empresa && !redirect)
            history.push(`/login?redirect=/e/${empresa.empresaId}`);
    }, [empresa]);
